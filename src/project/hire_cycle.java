...
import Interfaces.cycleCost;

public class hire_cycle extends JFrame implements ActionListener,MouseListener, cycleCost {
	JPanel p1,p2,p3;
	...
	ImageIcon vehicle=new ImageIcon(".\\Images\\big_cycle.gif");
