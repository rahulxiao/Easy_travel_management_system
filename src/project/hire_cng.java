...
import Interfaces.cngCost;

public class hire_cng extends JFrame implements ActionListener,MouseListener, cngCost {
	JPanel p1,p2,p3;
	...
	ImageIcon vehicle=new ImageIcon(".\\Images\\big_cng.gif");
