...
import Interfaces.vipCarCost;

public class hire_vip_car extends JFrame implements ActionListener,MouseListener, vipCarCost {
	JPanel p1,p2,p3;
	...
	ImageIcon vehicle=new ImageIcon(".\\Images\\big_vipCar.gif");
