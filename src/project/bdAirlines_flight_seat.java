...
public class bdAirlines_flight_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon ena_bus=new ImageIcon(".\\Images\\bdAirlines.jpg");
	public bdAirlines_flight_seat(){
		...
		l8=new JLabel();
        l8.setText("Bangladesh Airlines");
	...
	public static void main(String[] args) {
		bdAirlines_flight_seat bt=new bdAirlines_flight_seat();
        bt.show();
    }
}