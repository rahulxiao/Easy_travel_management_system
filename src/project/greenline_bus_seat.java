...
public class greenline_bus_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon greenline_bus=new ImageIcon(".\\Images\\green_bus.jpg");
	public greenline_bus_seat(){
	...
	public static void main(String[] args) {
		greenline_bus_seat bt=new greenline_bus_seat();
        bt.show();
    }
}
