...
public class ostrich_launch_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon ena_bus=new ImageIcon(".\\Images\\ostichLaunch.jpg");
	public ostrich_launch_seat(){
	...
	public static void main(String[] args) {
		ostrich_launch_seat bt=new ostrich_launch_seat();
        bt.show();
    }
}