...
import Interfaces.carCost;


public class hire_car extends JFrame implements ActionListener,MouseListener, carCost {
	JPanel p1,p2,p3;
	...
	ImageIcon vehicle=new ImageIcon(".\\Images\\big_car.gif");
