...
import Interfaces.miniBusCost;

public class hire_mini_bus extends JFrame implements ActionListener,MouseListener, miniBusCost {
	JPanel p1,p2,p3;
	...
	ImageIcon vehicle=new ImageIcon(".\\Images\\big_miniBus.gif");
