...
public class hire_motor_cycle extends JFrame implements ActionListener,MouseListener,motorCycleCost {
	JPanel p1,p2,p3;
	...
	ImageIcon vehicle=new ImageIcon(".\\Images\\big_motor_cycle.gif");
