...
public class bayCruiser_Launch_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon ena_bus=new ImageIcon(".\\Images\\bayCruiserLaunch.jpg");
	public bayCruiser_Launch_seat(){
	...
	public void mouseClicked(MouseEvent e) {
		if(e.getSource()==l64) {
			...
			launch_ticket obj=new launch_ticket();
			obj.show();
		}
		if(e.getSource()==l1) {
			this.setVisible(false);
	...
	public static void main(String[] args) {
		bayCruiser_Launch_seat bt=new bayCruiser_Launch_seat();
        bt.show();
    }
}