...
public class ena_bus_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon ena_bus=new ImageIcon(".\\Images\\ena_bus.jpg");
	public ena_bus_seat(){
	...
	public static void main(String[] args) {
		ena_bus_seat bt=new ena_bus_seat();
        bt.show();
    }
}