...
public class bus_ticket extends JFrame implements ActionListener,MouseListener {
    JPanel p1,p2,p3,p4,p5;
    JButton b1,b2,b3;
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l11,l12,l13,l14,l15,l16,l17,l18,l19,l21,l22,l23,l24;
    JLabel l25,l26,l27,l28,l29,l30,l31,l32,l33,l34,l35,l36,l37,l38,l39,l40,l41,l42,l43,l44;
    JLabel l45,l46,l47,l48,l49,l50,l51,l52,l53;
    ...
    public bus_ticket() {
        ...
        //first panel
        l1=new JLabel();
        l1.setText("Ena Paribohon");
        l1.setFont(new Font("Airal",Font.BOLD,20));
        ...
        l2=new JLabel();
        l2.setText("A/C Bus");
        l2.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l3.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l11.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l12=new JLabel();
        l12.setText("20:30");
        l12.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l13.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l14=new JLabel();
        l14.setText("1");
        l14.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l15=new JLabel();
        l15.setText("hrs");
        l15.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l16=new JLabel();
        l16.setText("20");
        l16.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l17=new JLabel();
        l17.setText("min");
        l17.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l18=new JLabel();
        l18.setText("21:50");
        l18.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l19.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l21.setFont(new Font("Airal",Font.BOLD,20));
        ...
        l22=new JLabel();
        l22.setText("800tk");
        l22.setFont(new Font("Airal",Font.BOLD,20));
        ...
        b1.setFont(new Font("Airal",Font.BOLD,10));
        ...
        //second
        l23=new JLabel();
        l23.setText("Shyamoli Paribohon");
        l23.setFont(new Font("Airal",Font.BOLD,20));
        ...
        l24=new JLabel();
        l24.setText("A/C Bus");
        l24.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l25.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l26.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l27=new JLabel();
        l27.setText("20:30");
        l27.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l28.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l29=new JLabel();
        l29.setText("1");
        l29.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l30=new JLabel();
        l30.setText("hrs");
        l30.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l31=new JLabel();
        l31.setText("20");
        l31.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l32=new JLabel();
        l32.setText("min");
        l32.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l33=new JLabel();
        l33.setText("21:50");
        l33.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l34.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l35.setFont(new Font("Airal",Font.BOLD,20));
        ...
        l36=new JLabel();
        l36.setText("800tk");
        l36.setFont(new Font("Airal",Font.BOLD,20));
        ...
        b2.setFont(new Font("Airal",Font.BOLD,10));
        ...
        //third
        l37=new JLabel();
        l37.setText("Green Line");
        l37.setFont(new Font("Airal",Font.BOLD,20));
        ...
        l38=new JLabel();
        l38.setText("A/C Bus");
        l38.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l39.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l40.setFont(new Font("Airal",Font.BOLD,19));
        ...
        l41=new JLabel();
        l41.setText("20:30");
        l41.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l42.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l43=new JLabel();
        l43.setText("1");
        l43.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l44=new JLabel();
        l44.setText("hrs");
        l44.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l45=new JLabel();
        l45.setText("20");
        l45.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l46=new JLabel();
        l46.setText("min");
        l46.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l47=new JLabel();
        l47.setText("21:50");
        l47.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l48.setFont(new Font("Airal",Font.BOLD,30));
        ...
        l49.setFont(new Font("Airal",Font.BOLD,20));
        ...
        l50=new JLabel();
        l50.setText("800tk");
        l50.setFont(new Font("Airal",Font.BOLD,20));
        ...
        b3.setFont(new Font("Airal",Font.BOLD,10));
    ...
    public void actionPerformed (ActionEvent e){
    	if(e.getSource()==b1) {
    		...
    		ena_bus_seat obj=new ena_bus_seat();
    		obj.show();
    	}
    	else if(e.getSource()==b2) {
    		this.setVisible(false);
    		shyamoli_bus_seat obj=new shyamoli_bus_seat();
    		obj.show();
    	}
    	else if(e.getSource()==b3) {
    		this.setVisible(false);
    		greenline_bus_seat obj=new greenline_bus_seat();
    		obj.show();
    	}
    }
