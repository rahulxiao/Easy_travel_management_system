...
public class indAirlines_flight_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon ena_bus=new ImageIcon(".\\Images\\indAirlines.jpg");
	public indAirlines_flight_seat(){
	...
	public static void main(String[] args) {
		indAirlines_flight_seat bt=new indAirlines_flight_seat();
        bt.show();
    }
}