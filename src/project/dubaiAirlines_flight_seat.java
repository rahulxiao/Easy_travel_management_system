...
public class dubaiAirlines_flight_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon ena_bus=new ImageIcon(".\\Images\\dubaiAirlines.jpg");
	public dubaiAirlines_flight_seat(){
	...
	public void mouseClicked(MouseEvent e) {
		if(e.getSource()==l64) {
			...
			flight_ticket obj=new flight_ticket();
			obj.show();
		}
		if(e.getSource()==l1) {
			this.setVisible(false);
	...
	public static void main(String[] args) {
		dubaiAirlines_flight_seat bt=new dubaiAirlines_flight_seat();
        bt.show();
    }
}