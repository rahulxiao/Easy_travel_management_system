...
public class greenLine_launch_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon ena_bus=new ImageIcon(".\\Images\\greenLineLaunch.jpg");
	public greenLine_launch_seat(){
	...
	public static void main(String[] args) {
		greenLine_launch_seat bt=new greenLine_launch_seat();
        bt.show();
    }
}