...
public class hire_delivery_man extends JFrame implements ActionListener,MouseListener,deliveryManCost {
	JPanel p1,p2,p3;
	...
	ImageIcon vehicle=new ImageIcon(".\\Images\\big_deliveryMan.gif");
	...
	public double total_cost_deliveryMan(double x) {
		cost= x*costPerHour;
		return cost;
	}
