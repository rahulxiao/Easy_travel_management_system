...
public class karnofuli_train_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon jamuna_train=new ImageIcon(".\\Images\\karnofuli_train.jpg");
	karnofuli_train_seat(){
		this.setDefaultCloseOperation(EXIT_ON_CLOSE);
        this.setLayout(null);
        this.getContentPane().setBackground(new Color(174, 226, 255));
        ...
        p2.setBackground(new Color(172, 188, 255));
        p2.setLayout(null);
        this.add(p2);
        
        p3=new JPanel();
        p3.setBounds(490,150,930,620);
        ...
        p4.setBackground(new Color(0, 173, 181));
        p4.setLayout(null);
        p3.add(p4);
        ...
        l23.setBackground(new Color(0, 173, 181));
        ...
        l24.setBackground(new Color(0, 173, 181));
        l24.setFocusable(false);
        l24.setBorder(BorderFactory.createEmptyBorder());
        l24.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l24.setIcon(seat1);
				String seat_Num="A2";
				String fare="800";
        ...
        l25.setBackground(new Color(0, 173, 181));
        ...
        l26.setBackground(new Color(0, 173, 181));
        l24.setFocusable(false);
        l25.setFocusable(false);
        l26.setFocusable(false);
        l26.setBorder(BorderFactory.createEmptyBorder());
        l26.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l26.setIcon(seat1);
				String seat_Num="A4";
				String fare="800";
        ...
        l27.setBackground(new Color(0, 173, 181));
        l27.setFocusable(false);
        l27.setBorder(BorderFactory.createEmptyBorder());
        l27.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l27.setIcon(seat1);
				String seat_Num="A5";
				String fare="800";
        ...
        l28.setBackground(new Color(0, 173, 181));
        ...
        l29.setBackground(new Color(0, 173, 181));
        l29.setFocusable(false);
        l29.setBorder(BorderFactory.createEmptyBorder());
        l29.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l29.setIcon(seat1);
				String seat_Num="A7";
				String fare="800";
        ...
        l30.setBackground(new Color(0, 173, 181));
        ...
        l31.setBackground(new Color(0, 173, 181));
        l31.setFocusable(false);
        l31.setBorder(BorderFactory.createEmptyBorder());
        l31.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l31.setIcon(seat1);
				String seat_Num="A9";
				String fare="800";
        ...
        l32.setBackground(new Color(0, 173, 181));
        ...
        l33.setBackground(new Color(0, 173, 181));
        l33.setFocusable(false);
        l33.setBorder(BorderFactory.createEmptyBorder());
        l33.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l33.setIcon(seat1);
				String seat_Num="A11";
				String fare="800";
        ...
        l34.setBackground(new Color(0, 173, 181));
        ...
        l35.setBackground(new Color(0, 173, 181));
        l35.setFocusable(false);
        l35.setBorder(BorderFactory.createEmptyBorder());
        l35.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l35.setIcon(seat1);
				String seat_Num="A13";
				String fare="800";
        ...
        l36.setBackground(new Color(0, 173, 181));
        l36.setFocusable(false);
        l36.setBorder(BorderFactory.createEmptyBorder());
        l36.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l36.setIcon(seat1);
				String seat_Num="A14";
				String fare="800";
        ...
        l37.setBackground(new Color(0, 173, 181));
        l37.setFocusable(false);
        l37.setBorder(BorderFactory.createEmptyBorder());
        l37.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l37.setIcon(seat1);
				String seat_Num="A15";
				String fare="800";
        ...
        l38.setBackground(new Color(0, 173, 181));
        l38.setFocusable(false);
        l38.setBorder(BorderFactory.createEmptyBorder());
        l38.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l38.setIcon(seat1);
				String seat_Num="A16";
				String fare="800";
        ...
        l39.setBackground(new Color(0, 173, 181));
        l39.setFocusable(false);
        l39.setBorder(BorderFactory.createEmptyBorder());
        l39.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l39.setIcon(seat1);
				String seat_Num="A17";
				String fare="800";
        ...
        l40.setBackground(new Color(0, 173, 181));
        l40.setFocusable(false);
        l40.setBorder(BorderFactory.createEmptyBorder());
        l40.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l40.setIcon(seat1);
				String seat_Num="A18";
				String fare="800";
        ...
        l41.setBackground(new Color(0, 173, 181));
        l41.setFocusable(false);
        l41.setBorder(BorderFactory.createEmptyBorder());
        l41.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l41.setIcon(seat1);
				String seat_Num="A19";
				String fare="800";
        ...
        l43.setBackground(new Color(0, 173, 181));
        l43.setFocusable(false);
        l43.setBorder(BorderFactory.createEmptyBorder());
        l43.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l43.setIcon(seat1);
				String seat_Num="B1";
				String fare="800";
        ...
        l44.setBackground(new Color(0, 173, 181));
        l44.setFocusable(false);
        l44.setBorder(BorderFactory.createEmptyBorder());
        l44.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l44.setIcon(seat1);
				String seat_Num="B2";
				String fare="800";
        ...
        l45.setBackground(new Color(0, 173, 181));
        l45.setFocusable(false);
        l45.setBorder(BorderFactory.createEmptyBorder());
        l45.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l45.setIcon(seat1);
				String seat_Num="B3";
				String fare="800";
        ...
        l46.setBackground(new Color(0, 173, 181));
        l46.setFocusable(false);
        l46.setBorder(BorderFactory.createEmptyBorder());
        l46.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l46.setIcon(seat1);
				String seat_Num="B4";
				String fare="800";
        ...
        l47.setBackground(new Color(0, 173, 181));
        l47.setFocusable(false);
        l47.setBorder(BorderFactory.createEmptyBorder());
        l47.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l47.setIcon(seat1);
				String seat_Num="B5";
				String fare="800";
        ...
        l48.setBackground(new Color(0, 173, 181));
        l48.setFocusable(false);
        l48.setBorder(BorderFactory.createEmptyBorder());
        l48.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l48.setIcon(seat1);
				String seat_Num="B6";
				String fare="800";
        ...
        l49.setBackground(new Color(0, 173, 181));
        l49.setFocusable(false);
        l49.setBorder(BorderFactory.createEmptyBorder());
        l49.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l49.setIcon(seat1);
				String seat_Num="B7";
				String fare="800";
        ...
        l50.setBackground(new Color(0, 173, 181));
        l50.setFocusable(false);
        l50.setBorder(BorderFactory.createEmptyBorder());
        l50.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l50.setIcon(seat1);
				String seat_Num="B8";
				String fare="800";
        ...
        l51.setBackground(new Color(0, 173, 181));
        l51.setFocusable(false);
        l51.setBorder(BorderFactory.createEmptyBorder());
        l51.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l51.setIcon(seat1);
				String seat_Num="B9";
				String fare="800";
        ...
        l53.setBackground(new Color(0, 173, 181));
        l53.setFocusable(false);
        l53.setBorder(BorderFactory.createEmptyBorder());
        l53.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l53.setIcon(seat1);
				String seat_Num="B11";
				String fare="800";
        ...
        l54.setBackground(new Color(0, 173, 181));
        l54.setFocusable(false);
        l54.setBorder(BorderFactory.createEmptyBorder());
        l54.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l54.setIcon(seat1);
				String seat_Num="B12";
				String fare="800";
        ...
        l55.setBackground(new Color(0, 173, 181));
        l55.setFocusable(false);
        l55.setBorder(BorderFactory.createEmptyBorder());
        l55.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l55.setIcon(seat1);
				String seat_Num="B13";
				String fare="800";
        ...
        l56.setBackground(new Color(0, 173, 181));
        l56.setFocusable(false);
        l56.setBorder(BorderFactory.createEmptyBorder());
        l56.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l56.setIcon(seat1);
				String seat_Num="B14";
				String fare="800";
        ...
        l57.setBackground(new Color(0, 173, 181));
        l57.setFocusable(false);
        l57.setBorder(BorderFactory.createEmptyBorder());
        l57.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l57.setIcon(seat1);
				String seat_Num="B15";
				String fare="800";
        ...
        l58.setBackground(new Color(0, 173, 181));
        l58.setFocusable(false);
        l58.setBorder(BorderFactory.createEmptyBorder());
        l58.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l58.setIcon(seat1);
				String seat_Num="B16";
				String fare="800";
        ...
        l59.setBackground(new Color(0, 173, 181));
        l59.setFocusable(false);
        l59.setBorder(BorderFactory.createEmptyBorder());
        l59.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l59.setIcon(seat1);
				String seat_Num="B17";
				String fare="800";
        ...
        l60.setBackground(new Color(0, 173, 181));
        l60.setFocusable(false);
        l60.setBorder(BorderFactory.createEmptyBorder());
        l60.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l60.setIcon(seat1);
				String seat_Num="B18";
				String fare="800";
        ...
        l61.setBackground(new Color(0, 173, 181));
        l61.setFocusable(false);
        l61.setBorder(BorderFactory.createEmptyBorder());
        l61.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l61.setIcon(seat1);
				String seat_Num="B19";
				String fare="800";
        ...
        l62.setBackground(new Color(0, 173, 181));
        l62.setFocusable(false);
        l62.setBorder(BorderFactory.createEmptyBorder());
        l62.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				l62.setIcon(seat1);
				String seat_Num="B20";
				String fare="800";
        ...
        l65=new JLabel();
        l65.setIcon(jamuna_train);
        l65.setBounds(0,200,400,260);
        p2.add(l65);
	...
	public void mouseClicked(MouseEvent e) {
		if(e.getSource()==l64) {
			...
			Train_Ticket obj=new Train_Ticket();
			obj.show();
		}
	}
