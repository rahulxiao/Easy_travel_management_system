...
public class jamuna_train_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon jamuna_train=new ImageIcon(".\\Images\\jamuna_train.jpg");
	jamuna_train_seat(){
