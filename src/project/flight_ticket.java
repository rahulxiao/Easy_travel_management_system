...
public class flight_ticket extends JFrame implements ActionListener,MouseListener {
	...
	ImageIcon plane=new ImageIcon(".\\Images\\plane.gif");
    public flight_ticket() {
        this.setDefaultCloseOperation(EXIT_ON_CLOSE);
        this.setLayout(null);
        this.getContentPane().setBackground(new Color(247,251,242));
        ...
        p2.setBackground(new Color(247,251,242));
        p2.setLayout(null);
        this.add(p2);
        
        l53=new JLabel();
        l53.setIcon(plane);
        l53.setBounds(60,200,300,300);
        p2.add(l53);
        //first
        p3=new JPanel();
        ...
        //first panel
        l1=new JLabel();
        l1.setText("Bangladesh Airlines");
    ...
    public void actionPerformed (ActionEvent e){
    	if(e.getSource()==b1) {
    		...
    		bdAirlines_flight_seat obj=new bdAirlines_flight_seat();
    		obj.show();
    	}
    	if(e.getSource()==b2) {
    		this.setVisible(false);
    		indAirlines_flight_seat obj=new indAirlines_flight_seat();
    		obj.show();
    	}
    	if(e.getSource()==b3) {
    		this.setVisible(false);
    		dubaiAirlines_flight_seat obj=new dubaiAirlines_flight_seat();
    		obj.show();
    	}
    }
    public static void main(String[] args) {
        flight_ticket bt=new flight_ticket();
        bt.show();
    }
