...
public class launch_ticket extends JFrame implements ActionListener,MouseListener {
    JPanel p1,p2,p3,p4,p5;
    JButton b1,b2,b3;
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l11,l12,l13,l14,l15,l16,l17,l18,l19,l21,l22,l23,l24,l25,l26,l27,l28,l29,l30,l31,l32,l33,l34,l35,l36,l37,l38,l39,l40,l41,l42,l43,l44,l45,l46,l47,l48,l49,l50,l51;
    JLabel l53,l52;
    ImageIcon profile=new ImageIcon(".\\Images\\profile.png");
    ImageIcon launch=new ImageIcon(".\\Images\\ship.gif");
    ImageIcon back=new ImageIcon(".\\Images\\backButton.png");
	ImageIcon back1=new ImageIcon(".\\Images\\back1.png");
    public launch_ticket() {
        this.setDefaultCloseOperation(EXIT_ON_CLOSE);
        this.setLayout(null);
        this.getContentPane().setBackground(new Color(127,216,248));
        ...
        p2=new JPanel();
        p2.setBounds(10,60,400,1920);
        p2.setBackground(new Color(127,216,248));
        p2.setLayout(null);
        this.add(p2);
        
        l53=new JLabel();
        l53.setIcon(launch);
        l53.setBounds(-65,40,500,600);
        p2.add(l53);
    ...
    public void actionPerformed (ActionEvent e){
    	if(e.getSource()==b1) {
    		...
    		greenLine_launch_seat obj=new greenLine_launch_seat();
    		obj.show();
    	}
    	if(e.getSource()==b2) {
    		this.setVisible(false);
    		bayCruiser_Launch_seat obj=new bayCruiser_Launch_seat();
    		obj.show();
    	}
    	if(e.getSource()==b3) {
    		this.setVisible(false);
    		ostrich_launch_seat obj=new ostrich_launch_seat();
    		obj.show();
    	}
    }
    public static void main(String[] args) {
        launch_ticket bt=new launch_ticket();
        bt.show();
    }
