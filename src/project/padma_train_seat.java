...
public class padma_train_seat extends JFrame implements ActionListener,MouseListener{
	...
	ImageIcon jamuna_train=new ImageIcon(".\\Images\\padma_train.jpg");
	padma_train_seat(){
